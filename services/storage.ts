...
import { User, Session, Contact, Message, MutedChat, Setting, ScheduledCampaign, AuthState } from '../models/index.js';
...
class MongoStorage {
    ...
    getModel(collection: string) {
        switch (collection) {
            ...
            case 'auth_states': return AuthState;
    ...
    async getMessages(sessionId: string, limit: number = 50, remoteJid?: string): Promise<any[]> {
